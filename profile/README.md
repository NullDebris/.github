...
### The following manifests track branches that are no longer maintained and are outdated!
...
> ~~- Will quite often get stuck when booting or rebooting (after a password is set). This is due to the secure side of the device (securemsm) not properly responding/being handled for some reason~~

**Should no longer be an issue with the latest firmware.**
